#!/bin/bash
#Realizar un script que copie el fichero indicado como primer parámetro de manera que la
#copia tenga el nombre indicado en el segundo parámetro. Hay que controlar:
...
if [[ $# -eq 2 ]]; then
	...
	echo "Error. Se deben introducir 2 parámetros, el primero debe existir, el segundo no"
fi
